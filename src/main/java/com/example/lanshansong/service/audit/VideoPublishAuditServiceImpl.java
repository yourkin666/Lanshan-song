...
import com.example.lanshansong.Entity.response.AuditResponse;
...
public class VideoPublishAuditServiceImpl implements AuditService<VideoTask,VideoTask> , InitializingBean,BeanPostProcessor {
    ...
    public VideoTask audit(VideoTask videoTask) {
        executor.submit(()->{
            ...
            if (videoTask.getIsAdd()  && Objects.equals(videoTask.getOldState(), videoTask.getNewState())){
                needAuditVideo = true;
            }else if (!videoTask.getIsAdd() && !Objects.equals(videoTask.getOldState(), videoTask.getNewState())){
