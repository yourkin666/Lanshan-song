...
import com.example.lanshansong.Entity.video.Video;
import com.example.lanshansong.Entity.video.VideoShare;
import com.example.lanshansong.Entity.video.VideoStar;
import com.example.lanshansong.Entity.vo.BasePage;
import com.example.lanshansong.Entity.vo.HotVideo;
import com.example.lanshansong.Entity.vo.UserModel;
...
import com.example.lanshansong.constant.AuditStatus;
...
import com.example.lanshansong.mapper.video.VideoMapper;
import com.example.lanshansong.service.FeedService;
import com.example.lanshansong.service.FileService;
import com.example.lanshansong.service.InterestPushService;
import com.example.lanshansong.service.audit.VideoPublishAuditServiceImpl;
...
import com.example.lanshansong.service.video.VideoService;
import com.example.lanshansong.service.video.VideoShareService;
import com.example.lanshansong.service.video.VideoStarService;
import com.example.lanshansong.util.FileUtil;
...
public class VideoServiceImpl extends ServiceImpl<VideoMapper, Video> implements VideoService {
    ...
    public void setUserVoAndUrl(Collection<Video> videos) {
        if (!ObjectUtils.isEmpty(videos)) {
            ...
            final Map<Long, User> userMap = userService.list((Wrapper<User>) userIds).stream().collect(Collectors.toMap(User::getId, Function.identity()));
            for (Video video : videos) {
